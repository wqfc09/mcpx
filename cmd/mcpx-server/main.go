...
Usage:
  ...
  mcpx restart [--json]            安全替换受管 background Instance；会中断当前请求/Plugin 内存态
  ...
  mcpx plugin <command>            安装、激活、检查 MCPX Plugins
  mcpx tui [flags]                 MCPX native runtime TUI；tui pages 输出可托管整页 TUI
